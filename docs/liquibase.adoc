...
* initial-data
** Initial data for developers, this should not be ran on PROD/UAT since it's used for inserting initial data for developers and the data is already in PROD/UAT databases.
...
WARNING: Running initial-data on production/UAT will cause liquibase to fail. The initial-data should only be set when you want to create initial data for development purposes or an initial setup of SeqDB.
