...
import ca.gc.aafc.seqdb.api.mapper.GenericMolecularAnalysisItemMapper;
...
public class GenericMolecularAnalysisItemRepository extends DinaRepositoryV2<GenericMolecularAnalysisItemDto, GenericMolecularAnalysisItem> {
  ...
  public GenericMolecularAnalysisItemRepository(
    ...
    super(
      ...
      Optional.empty(),
      GenericMolecularAnalysisItemMapper.INSTANCE,
      GenericMolecularAnalysisItemDto.class,
      GenericMolecularAnalysisItem.class,
      props, objMapper, new DinaMappingRegistry(GenericMolecularAnalysisItemDto.class, true));

    this.dinaAuthenticatedUser = dinaAuthenticatedUser.orElse(null);
  }

  @Override
  protected Link generateLinkToResource(GenericMolecularAnalysisItemDto dto) {
    try {
      return linkTo(methodOn(GenericMolecularAnalysisItemRepository.class).onFindOne(dto.getUuid(), null)).withSelfRel();
  ...
  @PostMapping(path = GenericMolecularAnalysisItemDto.TYPENAME + "/" + DinaRepositoryV2.JSON_API_BULK_LOAD_PATH, consumes = JSON_API_BULK)
  ...
  @GetMapping(GenericMolecularAnalysisItemDto.TYPENAME + "/{id}")
  public ResponseEntity<RepresentationModel<?>> onFindOne(@PathVariable UUID id, HttpServletRequest req)
      throws ResourceNotFoundException, ResourceGoneException {
    return handleFindOne(id, req);
  }

  @GetMapping(GenericMolecularAnalysisItemDto.TYPENAME)
  public ResponseEntity<RepresentationModel<?>> onFindAll(HttpServletRequest req) {
    return handleFindAll(req);
  }

  @PostMapping(path = GenericMolecularAnalysisItemDto.TYPENAME + "/" + DinaRepositoryV2.JSON_API_BULK_PATH, consumes = JSON_API_BULK)
  @Transactional
  ...
  @PostMapping(GenericMolecularAnalysisItemDto.TYPENAME)
  @Transactional
  ...
  @PatchMapping(GenericMolecularAnalysisItemDto.TYPENAME + "/{id}")
  @Transactional
  ...
  @PatchMapping(path = GenericMolecularAnalysisItemDto.TYPENAME + "/" + DinaRepositoryV2.JSON_API_BULK_PATH, consumes = JSON_API_BULK)
  @Transactional
  ...
  @DeleteMapping(path = GenericMolecularAnalysisItemDto.TYPENAME + "/" + DinaRepositoryV2.JSON_API_BULK_PATH, consumes = JSON_API_BULK)
  @Transactional
  ...
  @DeleteMapping(GenericMolecularAnalysisItemDto.TYPENAME + "/{id}")
  @Transactional
