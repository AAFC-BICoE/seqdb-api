...
import ca.gc.aafc.seqdb.api.mapper.LibraryPrepBatchMapper;
...
public class LibraryPrepBatchRepository extends DinaRepositoryV2<LibraryPrepBatchDto, LibraryPrepBatch> {
  ...
  public LibraryPrepBatchRepository(
    ...
    super(
      ...
      Optional.empty(),
      LibraryPrepBatchMapper.INSTANCE,
      LibraryPrepBatchDto.class,
      LibraryPrepBatch.class,
      props, objMapper, new DinaMappingRegistry(LibraryPrepBatchDto.class, true));

    this.dinaAuthenticatedUser = dinaAuthenticatedUser.orElse(null);
  }

  @Override
  protected Link generateLinkToResource(LibraryPrepBatchDto dto) {
    try {
  ...
  @PostMapping(path = LibraryPrepBatchDto.TYPENAME + "/" + DinaRepositoryV2.JSON_API_BULK_LOAD_PATH, consumes = JSON_API_BULK)
  ...
  @GetMapping(LibraryPrepBatchDto.TYPENAME + "/{id}")
  public ResponseEntity<RepresentationModel<?>> onFindOne(@PathVariable UUID id, HttpServletRequest req)
      throws ResourceNotFoundException, ResourceGoneException {
    return handleFindOne(id, req);
  }

  @GetMapping(LibraryPrepBatchDto.TYPENAME)
  public ResponseEntity<RepresentationModel<?>> onFindAll(HttpServletRequest req) {
    return handleFindAll(req);
  }

  @PostMapping(path = LibraryPrepBatchDto.TYPENAME + "/" + DinaRepositoryV2.JSON_API_BULK_PATH, consumes = JSON_API_BULK)
  @Transactional
  ...
  @PostMapping(LibraryPrepBatchDto.TYPENAME)
  @Transactional
  ...
  @PatchMapping(LibraryPrepBatchDto.TYPENAME + "/{id}")
  @Transactional
  ...
  @PatchMapping(path = LibraryPrepBatchDto.TYPENAME + "/" + DinaRepositoryV2.JSON_API_BULK_PATH, consumes = JSON_API_BULK)
  @Transactional
  ...
  @DeleteMapping(path = LibraryPrepBatchDto.TYPENAME + "/" + DinaRepositoryV2.JSON_API_BULK_PATH, consumes = JSON_API_BULK)
  @Transactional
  ...
  @DeleteMapping(LibraryPrepBatchDto.TYPENAME + "/{id}")
  @Transactional
