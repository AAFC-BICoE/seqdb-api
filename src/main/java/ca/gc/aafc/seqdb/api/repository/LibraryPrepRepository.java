...
import ca.gc.aafc.seqdb.api.mapper.LibraryPrepMapper;
...
public class LibraryPrepRepository extends DinaRepositoryV2<LibraryPrepDto, LibraryPrep> {
  ...
  public LibraryPrepRepository(
    ...
    super(
      ...
      Optional.empty(),
      LibraryPrepMapper.INSTANCE,
      LibraryPrepDto.class,
      LibraryPrep.class,
      props, objMapper, new DinaMappingRegistry(LibraryPrepDto.class, true));

    this.dinaAuthenticatedUser = dinaAuthenticatedUser.orElse(null);
  }

  @Override
  protected Link generateLinkToResource(LibraryPrepDto dto) {
    try {
  ...
  @PostMapping(path = LibraryPrepDto.TYPENAME + "/" + DinaRepositoryV2.JSON_API_BULK_LOAD_PATH, consumes = JSON_API_BULK)
  ...
  @GetMapping(LibraryPrepDto.TYPENAME + "/{id}")
  public ResponseEntity<RepresentationModel<?>> onFindOne(@PathVariable UUID id, HttpServletRequest req)
    throws ResourceNotFoundException, ResourceGoneException {
    return handleFindOne(id, req);
  }

  @GetMapping(LibraryPrepDto.TYPENAME)
  public ResponseEntity<RepresentationModel<?>> onFindAll(HttpServletRequest req) {
    return handleFindAll(req);
  }

  @PostMapping(path = LibraryPrepDto.TYPENAME + "/" + DinaRepositoryV2.JSON_API_BULK_PATH, consumes = JSON_API_BULK)
  @Transactional
  ...
  @PostMapping(LibraryPrepDto.TYPENAME)
  @Transactional
  ...
  @PatchMapping(LibraryPrepDto.TYPENAME + "/{id}")
  @Transactional
  ...
  @PatchMapping(path = LibraryPrepDto.TYPENAME + "/" + DinaRepositoryV2.JSON_API_BULK_PATH, consumes = JSON_API_BULK)
  @Transactional
  ...
  @DeleteMapping(path = LibraryPrepDto.TYPENAME + "/" + DinaRepositoryV2.JSON_API_BULK_PATH, consumes = JSON_API_BULK)
  @Transactional
  ...
  @DeleteMapping(LibraryPrepDto.TYPENAME + "/{id}")
  @Transactional
