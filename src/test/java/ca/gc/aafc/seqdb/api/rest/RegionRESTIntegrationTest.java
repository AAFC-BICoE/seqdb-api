...
public class RegionRESTIntegrationTest extends BaseRESTIntegrationTest {
    ...
    public void testCreateTask() {
        ...
        Map<String, Object> attributeMap = new ImmutableMap.Builder<String, Object>().
                put("name", "test name").put("description", "test description").put("symbol", "test symbol").build();

        Map dataMap = ImmutableMap.of("data", ImmutableMap.of("type", "region", "attributes", attributeMap));
    ...
    public void testUpdateTask() {
        ...
        //update
        Map<String, Object> attributeMapUpdate = new ImmutableMap.Builder<String, Object>().put("name", updatedName).put("description", updatedDescription)
                .put("symbol", updatedSymbol).build();

        Map dataMapUpdate = ImmutableMap.of("data", ImmutableMap.of("type", "region", "id", id, "attributes", attributeMapUpdate));
