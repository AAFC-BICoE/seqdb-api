...
import ca.gc.aafc.seqdb.api.mapper.SeqBatchMapper;
...
public class SeqBatchRepository extends DinaRepositoryV2<SeqBatchDto, SeqBatch> {
  ...
  public SeqBatchRepository(
    ...
    super(
      ...
      Optional.empty(),
      SeqBatchMapper.INSTANCE,
      SeqBatchDto.class,
      SeqBatch.class,
      props, objMapper, new DinaMappingRegistry(SeqBatchDto.class, true));
    this.dinaAuthenticatedUser = dinaAuthenticatedUser.orElse(null);
  }

  @Override
  protected Link generateLinkToResource(SeqBatchDto dto) {
    try {
  ...
  @PostMapping(path = SeqBatchDto.TYPENAME + "/" + DinaRepositoryV2.JSON_API_BULK_LOAD_PATH, consumes = JSON_API_BULK)
  ...
  @GetMapping(SeqBatchDto.TYPENAME + "/{id}")
  public ResponseEntity<RepresentationModel<?>> onFindOne(@PathVariable UUID id, HttpServletRequest req)
      throws ResourceNotFoundException, ResourceGoneException {
    return handleFindOne(id, req);
  }

  @GetMapping(SeqBatchDto.TYPENAME)
  public ResponseEntity<RepresentationModel<?>> onFindAll(HttpServletRequest req) {
    return handleFindAll(req);
  }

  @PostMapping(path = SeqBatchDto.TYPENAME + "/" + DinaRepositoryV2.JSON_API_BULK_PATH, consumes = JSON_API_BULK)
  @Transactional
  ...
  @PostMapping(SeqBatchDto.TYPENAME)
  @Transactional
  ...
  @PatchMapping(SeqBatchDto.TYPENAME + "/{id}")
  @Transactional
  ...
  @PatchMapping(path = SeqBatchDto.TYPENAME + "/" + DinaRepositoryV2.JSON_API_BULK_PATH, consumes = JSON_API_BULK)
  @Transactional
  ...
  @DeleteMapping(path = SeqBatchDto.TYPENAME + "/" + DinaRepositoryV2.JSON_API_BULK_PATH, consumes = JSON_API_BULK)
  @Transactional
  ...
  @DeleteMapping(SeqBatchDto.TYPENAME + "/{id}")
  @Transactional
