...
import ca.gc.aafc.seqdb.api.mapper.MolecularAnalysisRunMapper;
...
public class MolecularAnalysisRunRepository extends DinaRepositoryV2<MolecularAnalysisRunDto, MolecularAnalysisRun> {
  ...
  public MolecularAnalysisRunRepository(
    ...
    super(
      ...
      Optional.empty(),
      MolecularAnalysisRunMapper.INSTANCE,
      MolecularAnalysisRunDto.class,
      MolecularAnalysisRun.class,
      props, objMapper, new DinaMappingRegistry(MolecularAnalysisRunDto.class, true));

    this.dinaAuthenticatedUser = dinaAuthenticatedUser.orElse(null);
  }

  @Override
  protected Link generateLinkToResource(MolecularAnalysisRunDto dto) {
    try {
  ...
  @PostMapping(path = MolecularAnalysisRunDto.TYPENAME + "/" + DinaRepositoryV2.JSON_API_BULK_LOAD_PATH, consumes = JSON_API_BULK)
  ...
  @GetMapping(MolecularAnalysisRunDto.TYPENAME + "/{id}")
  public ResponseEntity<RepresentationModel<?>> onFindOne(@PathVariable UUID id, HttpServletRequest req)
      throws ResourceNotFoundException, ResourceGoneException {
    return handleFindOne(id, req);
  }

  @GetMapping(MolecularAnalysisRunDto.TYPENAME)
  public ResponseEntity<RepresentationModel<?>> onFindAll(HttpServletRequest req) {
    return handleFindAll(req);
  }

  @PostMapping(path = MolecularAnalysisRunDto.TYPENAME + "/" + DinaRepositoryV2.JSON_API_BULK_PATH, consumes = JSON_API_BULK)
  @Transactional
  ...
  @PostMapping(MolecularAnalysisRunDto.TYPENAME)
  @Transactional
  ...
  @PatchMapping(MolecularAnalysisRunDto.TYPENAME + "/{id}")
  @Transactional
  ...
  @PatchMapping(path = MolecularAnalysisRunDto.TYPENAME + "/" + DinaRepositoryV2.JSON_API_BULK_PATH, consumes = JSON_API_BULK)
  @Transactional
  ...
  @DeleteMapping(path = MolecularAnalysisRunDto.TYPENAME + "/" + DinaRepositoryV2.JSON_API_BULK_PATH, consumes = JSON_API_BULK)
  @Transactional
  ...
  @DeleteMapping(MolecularAnalysisRunDto.TYPENAME + "/{id}")
  @Transactional
