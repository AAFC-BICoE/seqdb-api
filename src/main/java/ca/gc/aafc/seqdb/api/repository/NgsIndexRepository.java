...
import ca.gc.aafc.seqdb.api.mapper.NgsIndexMapper;
...
public class NgsIndexRepository extends DinaRepositoryV2<NgsIndexDto, NgsIndex> {
  ...
  @Override
  protected Link generateLinkToResource(NgsIndexDto dto) {
    try {
  ...
  @PostMapping(path = NgsIndexDto.TYPENAME + "/" + DinaRepositoryV2.JSON_API_BULK_LOAD_PATH, consumes = JSON_API_BULK)
  ...
  @GetMapping(NgsIndexDto.TYPENAME + "/{id}")
  public ResponseEntity<RepresentationModel<?>> onFindOne(@PathVariable UUID id, HttpServletRequest req)
      throws ResourceNotFoundException, ResourceGoneException {
    return handleFindOne(id, req);
  }

  @GetMapping(NgsIndexDto.TYPENAME)
  public ResponseEntity<RepresentationModel<?>> onFindAll(HttpServletRequest req) {
    return handleFindAll(req);
  }

  @PostMapping(path = NgsIndexDto.TYPENAME + "/" + DinaRepositoryV2.JSON_API_BULK_PATH, consumes = JSON_API_BULK)
  @Transactional
  ...
  @PostMapping(NgsIndexDto.TYPENAME)
  @Transactional
  ...
  @PatchMapping(NgsIndexDto.TYPENAME + "/{id}")
  @Transactional
  ...
  @PatchMapping(path = NgsIndexDto.TYPENAME + "/" + DinaRepositoryV2.JSON_API_BULK_PATH, consumes = JSON_API_BULK)
  @Transactional
  ...
  @DeleteMapping(path = NgsIndexDto.TYPENAME + "/" + DinaRepositoryV2.JSON_API_BULK_PATH, consumes = JSON_API_BULK)
  @Transactional
  ...
  @DeleteMapping(NgsIndexDto.TYPENAME + "/{id}")
  @Transactional
