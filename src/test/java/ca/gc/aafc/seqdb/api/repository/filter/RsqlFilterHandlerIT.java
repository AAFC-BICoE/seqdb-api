...
public class RsqlFilterHandlerIT extends BaseRepositoryTest {
  ...
  public void findAllPrimers_whenRsqlFilterIsSet_filteredPrimersAreReturned() {
    ...
    persistTestPrimer().setName("primer1");
    persistTestPrimer().setName("primer2");
    persistTestPrimer().setName("primer3");
    persistTestPrimer().setName("primer4");
    persistTestPrimer().setName("primer5");
