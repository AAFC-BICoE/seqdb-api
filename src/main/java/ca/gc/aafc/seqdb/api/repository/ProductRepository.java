...
public class ProductRepository extends DinaRepositoryV2<ProductDto, Product> {
  ...
  @Override
  protected Link generateLinkToResource(ProductDto dto) {
    try {
      return linkTo(methodOn(ProductRepository.class).onFindOne(dto.getUuid(), null)).withSelfRel();
