...
import ca.gc.aafc.seqdb.api.mapper.LibraryPoolContentMapper;
...
public class LibraryPoolContentRepository extends DinaRepositoryV2<LibraryPoolContentDto, LibraryPoolContent> {
  ...
  public LibraryPoolContentRepository(
    ...
    super(
      ...
      Optional.empty(),
      LibraryPoolContentMapper.INSTANCE,
      LibraryPoolContentDto.class,
      LibraryPoolContent.class,
      props, objMapper, new DinaMappingRegistry(LibraryPoolContentDto.class, true));
    this.dinaAuthenticatedUser = dinaAuthenticatedUser.orElse(null);
  }

  @Override
  protected Link generateLinkToResource(LibraryPoolContentDto dto) {
    try {
  ...
  @PostMapping(path = LibraryPoolContentDto.TYPENAME + "/" + DinaRepositoryV2.JSON_API_BULK_LOAD_PATH, consumes = JSON_API_BULK)
  ...
  @GetMapping(LibraryPoolContentDto.TYPENAME + "/{id}")
  public ResponseEntity<RepresentationModel<?>> onFindOne(@PathVariable UUID id, HttpServletRequest req)
      throws ResourceNotFoundException, ResourceGoneException {
    return handleFindOne(id, req);
  }

  @GetMapping(LibraryPoolContentDto.TYPENAME)
  public ResponseEntity<RepresentationModel<?>> onFindAll(HttpServletRequest req) {
    return handleFindAll(req);
  }

  @PostMapping(path = LibraryPoolContentDto.TYPENAME + "/" + DinaRepositoryV2.JSON_API_BULK_PATH, consumes = JSON_API_BULK)
  @Transactional
  ...
  @PostMapping(LibraryPoolContentDto.TYPENAME)
  @Transactional
  ...
  @PatchMapping(LibraryPoolContentDto.TYPENAME + "/{id}")
  @Transactional
  ...
  @PatchMapping(path = LibraryPoolContentDto.TYPENAME + "/" + DinaRepositoryV2.JSON_API_BULK_PATH, consumes = JSON_API_BULK)
  @Transactional
  ...
  @DeleteMapping(path = LibraryPoolContentDto.TYPENAME + "/" + DinaRepositoryV2.JSON_API_BULK_PATH, consumes = JSON_API_BULK)
  @Transactional
  ...
  @DeleteMapping(LibraryPoolContentDto.TYPENAME + "/{id}")
  @Transactional
